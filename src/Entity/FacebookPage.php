...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FacebookPageRepository")
 */
class FacebookPage
{
     ...
     * @ORM\JoinTable(name="facebook_page_categories",
     * joinColumns={@ORM\JoinColumn(name="facebook_page_id", referencedColumnName="id")},
