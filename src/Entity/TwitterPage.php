...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TwitterPageRepository")
 */
class TwitterPage
{
     ...
     * @ORM\JoinTable(name="twitter_page_categories",
     * joinColumns={@ORM\JoinColumn(name="twitter_page_id", referencedColumnName="id")},
